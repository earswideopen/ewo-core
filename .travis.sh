...
EXT=${EXT:-tar.xz}
SUM=${SUM:-9908c75aabd49d13661d6dcb1bc382252d22cc77bf733a2d55e87f2aa2db8636}
...
EXT=${EXT:-tar.xz}
SUM=${SUM:-64ebcec9f8ac5b2487125a86a7760d2591ac9e1d3dbd59489633f9de62a57684}
wget https://ftp.gnu.org/gnu/$NAME/$NAME-$VERSION.$EXT
check_sig $SUM $NAME $VERSION $EXT
tar -xvf $NAME-$VERSION.$EXT
cd $NAME-$VERSION
...
EXT=${EXT:-tar.xz}
SUM=${SUM:-b36050d7a1224296803d216cba1a9d4c58c31bf308b2d6d6649d61aa5a36753b}
...
EXT=${EXT:-tar.gz}
SUM=${SUM:-510a13e0be57cd4ba99e60ac806a3635854af51316d3131d3742a90298ccde38}
